...
----
oc apply -n <your-project-name/> -f https://github.com/viniciusfcf/health-fraud-detection/raw/main/setup/setup-s3.yaml
----
====
      ...
      containers:
        - args:
            ...
            - |-
              ...
              oc apply -f https://github.com/viniciusfcf/health-fraud-detection/raw/main/setup/setup-s3-no-sa.yaml
          command:
            - /bin/bash
